...
void writekeymap() // create keymap.cfg with proper constants from SDL2 header files
{
    const struct _keymaptab { int keycode; const char *keyname; } keymaptab[] = {
        ...
        { -15, "MOUSE15" },
        { -16, "MOUSE16" },
        { -100, "CONTROLLER_BUTTON_A" },
        { -101, "CONTROLLER_BUTTON_B" },
        { -102, "CONTROLLER_BUTTON_X" },
        { -103, "CONTROLLER_BUTTON_Y" },
        { -104, "CONTROLLER_BUTTON_BACK" },
        { -105, "CONTROLLER_BUTTON_GUIDE" },
        { -106, "CONTROLLER_BUTTON_START" },
        { -107, "CONTROLLER_BUTTON_LEFTSTICK" },
        { -108, "CONTROLLER_BUTTON_RIGHTSTICK" },
        { -109, "CONTROLLER_BUTTON_LEFTSHOULDER" },
        { -110, "CONTROLLER_BUTTON_RIGHTSHOULDER" },
        { -111, "CONTROLLER_BUTTON_DPAD_UP" },
        { -112, "CONTROLLER_BUTTON_DPAD_DOWN" },
        { -113, "CONTROLLER_BUTTON_DPAD_LEFT" },
        { -114, "CONTROLLER_BUTTON_DPAD_RIGHT" },
        { -130, "CONTROLLER_AXIS_LEFTX_POS" },
        { -131, "CONTROLLER_AXIS_LEFTX_NEG" },
        { -132, "CONTROLLER_AXIS_LEFTY_POS" },
        { -133, "CONTROLLER_AXIS_LEFTY_NEG" },
        { -134, "CONTROLLER_AXIS_RIGHTX_POS" },
        { -135, "CONTROLLER_AXIS_RIGHTX_NEG" },
        { -136, "CONTROLLER_AXIS_RIGHTY_POS" },
        { -137, "CONTROLLER_AXIS_RIGHTY_NEG" },
        { -138, "CONTROLLER_AXIS_TRIGGERLEFT" },
        { -139, "CONTROLLER_AXIS_TRIGGERLEFT_NOP" },
        { -140, "CONTROLLER_AXIS_TRIGGERRIGHT" },
        { -141, "CONTROLLER_AXIS_TRIGGERRIGHT_NOP" },
